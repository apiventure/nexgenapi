module.exports = [
"[project]/src/app/components/fetchSpringApi.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$fetchSpringApi$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/fetchSpringApi.js [app-ssr] (ecmascript)");
"use client";
;
;
;
function Home() {
    ...
    const handleClick = async ()=>{
        ...
        setApiResult("");
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$fetchSpringApi$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchSpringApi"])();
            setApiResult(result);
        } catch (e) {
...
//# sourceMappingURL=src_app_components_97331c3b._.js.map